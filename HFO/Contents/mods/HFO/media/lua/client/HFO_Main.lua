...
function HFO.handleKeypress(keyNum)
	...
	elseif keyNum == HFO.hotkeys.AmmoSwap           then HFO.ReloadUtils.AmmoSwap(keyNum)
	elseif keyNum == HFO.hotkeys.AmmoSwapReverse    then HFO.ReloadUtils.AmmoSwapReverse(keyNum, true)
